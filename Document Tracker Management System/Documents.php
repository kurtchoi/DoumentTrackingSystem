...
<body>
  ...
  <a class="active" href="Documents.php">Documents</a>
...
<?php 
    ...
    $query  = "SELECT * FROM `docs` WHERE `Holder` = '".$accnum."'";
    $result = $conn->query($query);
    
    while ($row = $result->fetch_assoc()) {
        //echo "  To delete user   <b>" . $row['firstname'] . "</b>  Click on the number <input type='submit' name='delete' value='" . $row['id'] . "' /><br/>";
        //echo "<table>";
        echo "<tr><td>" . $row["DocNum"] . "</td><td>" . $row["DocName"] . "</td><td>". $row["Author"] . "</td><td>". $row["Remarks"] . "";
